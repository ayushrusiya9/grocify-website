...
//                         </li>
//                         <li>
//                             <Link to='/about' className='font-semibold tracking-wider text-zinc-800 hover:text-orange-500'>
//                             About
//                             </Link>
//                         </li>
//                         <li>
//                             <Link to="/products" className='font-semibold tracking-wider text-zinc-800 hover:text-orange-500'>
//                             Products
//                             </Link>
//                         </li>
...
const Navbar = () => {
  ...
  const navLinkClass = ({ isActive }) =>
    `font-semibold tracking-wider ${
      isActive ? "text-orange-500" : "text-zinc-800 hover:text-orange-500"
    }`;
    ...
    <>
      <header
        className={`bg-white fixed top-0 right-0 left-0 z-50 ${
          isScrolled ? 'drop-shadow-[0_4px_25px_rgba(0,0,0,0.2)]' : ''
        }`}
      >
        <nav className="max-w-[1400px] mx-auto px-10 md:h-[14vh] h-[10vh] flex justify-between items-center">
          <a href="/" className="text-2xl md:text-3xl font-bold">
          ...
          {/* mobile menu */}
          <ul
            className={`md:hidden flex flex-col gap-y-10 bg-orange-500/15 backdrop-blur-xl rounded-lg p-10 items-center absolute top-20 left-1/2 transform -translate-x-1/2 transition-all duration-500 ${
